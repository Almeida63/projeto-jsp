													...
													<div class="card-block">
														...
														<form class="form-material" enctype="multipart/form-data"
															...
															<div class="form-group form-default form-static-label">
																...
																<span class="form-bar"></span> <label
																	class="float-label" style="color: black">Dat. Nascimento:</label>
															</div>
															...
															<div class="form-group form-default form-static-label">
																...
																<span class="form-bar"></span> <label
																	class="float-label" style="color: black">Renda Mensal:</label>
															</div>
															...
															<div class="form-group form-default form-static-label">
																...
																<span class="form-bar"></span> <label
																	class="float-label" style="color: black">Cep:</label>
															</div>
															...
															<div class="form-group form-default form-static-label">
																...
																<span class="form-bar"></span> <label
																	class="float-label" style="color: black">Uf:</label>
															</div>
													...
													<c:forEach items='${modolLogins}' var="ml">
														<tr>
															...
															<td><a class="btn btn-info" href="#"
																onClick="criarDelete();">Deletar</a></td>
														</tr>
