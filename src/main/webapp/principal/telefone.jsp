														...
														<form class="form-material"
															...
															<div class="form-group form-default form-static-label">
																<input type="text" name="id" id="id"
																	...
																	style="color: black;">ID User:</label>
															</div>
															...
															<div class="form-group form-default form-static-label">
																...
																<label class="float-label" style="color: black">Numero:</label>
															</div>
													...
													<c:forEach items='${modelTelefones}' var="f">
														<tr>
															...
															<td><a class="btn btn-success"
																href="<%= request.getContextPath() %>/ServletTelefone?acao=excluir&id=${f.id}&userpai=${modelLogin.id}">Excluir</a>
															</td>
